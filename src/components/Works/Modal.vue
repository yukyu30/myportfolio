            ...
            <div class="relative w-auto my-6  max-w-3xl mx-1 md:mx-0">
                ...
                <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <div class="flex items-start justify-between p-5 border-b border-solid border-gray-300 rounded-t">
                        ...
                        <button class="h-8 w-8 text-red-500 bg-transparent border border-solid border-red-500 hover:bg-red-500 hover:text-white active:bg-red-600 font-bold text-sm p-1 rounded outline-none focus:outline-none" type="button" style="transition: all .15s ease" v-on:click="closeModal">
                            ×
                        </button>
                    </div>
                    <!--body-->
